...
import kr.co.booknuts.data.remote.JoinRequestDTO
import kr.co.booknuts.data.remote.User
        ...
        CompoundButton.OnCheckedChangeListener { compoundButton, isChecked ->
            ...
            if (isChecked) {
                ...
                when (compoundButton.id) {
                    ...
                    R.id.check_terms1 -> binding.textTerms1Type.setTextColor(ContextCompat.getColor(this,
                        R.color.coral_600
                    ))
                    R.id.check_terms2 -> binding.textTerms2Type.setTextColor(ContextCompat.getColor(this,
                        R.color.coral_600
                    ))
                    R.id.check_terms3 -> binding.textTerms3Type.setTextColor(ContextCompat.getColor(this,
                        R.color.coral_600
                    ))
                    R.id.check_terms4 -> binding.textTerms4Type.setTextColor(ContextCompat.getColor(this,
                        R.color.coral_600
                    ))
                }
            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.editPwd.addTextChangedListener {
            ...
            if (!binding.editPwdConfirm.text.toString().equals(binding.editPwd.text.toString()) && !binding.editPwdConfirm.text.isEmpty()) {
                ...
                binding.textPwdConfirmStatus.setTextColor(ContextCompat.getColor(this,
                    R.color.grey_200
                ))
            }
