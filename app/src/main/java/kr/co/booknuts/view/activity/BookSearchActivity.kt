...
class BookSearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.editBookTitle.setOnEditorActionListener { textView, i, keyEvent ->
            when(i) {
                EditorInfo.IME_ACTION_NEXT -> {searchBook(); true}
                EditorInfo.IME_ACTION_DONE -> {searchBook(); true}
                EditorInfo.IME_ACTION_SEARCH -> {searchBook(); true}
                EditorInfo.IME_ACTION_GO -> {searchBook(); true}
                else -> true
            }
        }
    }
